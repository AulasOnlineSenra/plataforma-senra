...
/**
 * Constrói um objeto de autenticação compatível com regras de segurança a partir do usuário do Firebase.
 * @param currentUser O usuário do Firebase atualmente autenticado.
 * @returns Um objeto que espelha request.auth nas regras de segurança, ou nulo.
 */
 ...
 * Ele tenta obter com segurança o usuário autenticado atual.
...
function buildRequestObject(context: SecurityRuleContext): SecurityRuleRequest {
  ...
  try {
    ...
    // Isso capturará erros se o aplicativo Firebase ainda não estiver inicializado.
 ...
 * Ela estrutura as informações de erro para imitar o objeto de requisição
