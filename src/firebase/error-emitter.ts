 ...
 * Isso centraliza as definições de eventos para segurança de tipo em toda a aplicação.
 */
...
function createEventEmitter<T extends Record<string, any>>() {
  // O objeto de eventos armazena arrays de callbacks, chaveados pelo nome do evento.
  ...
  return {
     ...
     * @param callback A função a ser chamada quando o evento é emitido.
     */
