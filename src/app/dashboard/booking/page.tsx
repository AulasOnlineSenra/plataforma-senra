        ...
        <Card className="rounded-3xl border border-slate-100 bg-white shadow-sm">
          ...
          <CardContent>
            <div className="rounded-2xl border border-slate-100 overflow-hidden">
              <div className="grid px-4 py-2.5 bg-slate-50 text-xs font-semibold text-slate-500 uppercase tracking-wide" style={{ gridTemplateColumns: "0.4fr 1fr 140px 110px 70px" }}>
              ...
              {preBookings.map((booking, idx) => {
                ...
                if (isEditing) {
                  return (
                    <div key={booking.id} className={`grid items-center px-4 py-3 bg-amber-50 ${idx > 0 ? "border-t border-slate-100" : ""}`} style={{ gridTemplateColumns: "0.4fr 1fr 140px 110px 70px" }}>
                      <div>
                ...
                return (
                  <div key={booking.id} className={`grid items-center px-4 py-3 ${idx > 0 ? "border-t border-slate-100" : ""}`} style={{ gridTemplateColumns: "0.4fr 1fr 140px 110px 70px" }}>
