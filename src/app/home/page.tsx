  ...
  return (
    <div className="flex flex-col min-h-screen bg-card">
      <header className="sticky top-0 z-50 flex items-center justify-between pr-4 pl-0 py-2 md:px-4 md:py-[2px] bg-card border-b h-[50px] lg:h-[47px]">
        <SenraLogo className="h-8 sm:h-10 -ml-[5px] md:ml-0" />
      ...
      <main className="flex-1">
        <section className="relative w-full h-[80vh] md:h-[90vh] flex items-center justify-center text-center text-white bg-black">
          ...
          <div className="relative z-10 p-4 max-w-4xl mx-auto">
            ...
            <h1 className="mt-[31px] text-3xl sm:text-4xl md:text-6xl font-black text-white mb-4 leading-[1.05] md:leading-none drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
        ...
        <section className="py-16 pt-[94px] bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center pt-[20px] pb-[44px] lg:pb-[110px] w-full flex justify-center">
              <h2 className="text-4xl md:text-5xl font-black font-headline tracking-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] leading-[1.05] md:leading-[calc(1.25em+2px)]">
