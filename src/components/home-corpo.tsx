      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
        ...
        <div className="bg-slate-50 rounded-3xl border border-slate-200 py-3 px-6 md:py-3 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden max-h-max md:max-h-[90px]">
          <div className="flex items-center gap-5 text-center md:text-left">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-[18px] md:text-lg mb-1">Não encontrou seu objetivo?</h4>
              <p className="text-[9px] md:text-sm text-slate-500 max-w-[calc(100%+5px)] md:max-w-none px-[2.5px] md:px-0">Fale com nossa equipe e descubra como podemos te ajudar.</p>
            </div>
          </div>
          <button 
