      ...
      <div className="block lg:hidden pt-12 pb-[15px] px-4">
        ...
        <div className="space-y-16">
          ...
          <div className="pt-10 border-t border-slate-800">
            ...
            <p className="hidden md:block text-slate-400 mb-8 text-sm text-center">
              Tudo conectado para você estudar com mais organização e direção.
            </p>
            <Button asChild className="w-full bg-amber-500 hover:bg-amber-400 text-slate-900 font-bold rounded-xl py-[21.5px] md:py-6 text-base shadow-[0_0_20px_rgba(245,158,11,0.3)] mb-[10px]">
              <Link href="/register">
          ...
          <div className="container mx-auto px-4 lg:px-8 h-full max-h-[900px] flex flex-col justify-center py-10 relative">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between w-full h-full mt-24 lg:mt-32 gap-8 lg:gap-12 relative z-10 lg:pl-[60px] lg:-mr-[60px]">
              ...
              <div className="w-full lg:w-[55%] flex flex-col items-center justify-center relative order-1 lg:order-2 perspective-1000 gap-5 max-w-[750px] mx-auto lg:translate-x-[65px]">
                ...
                <div className="w-[calc(100%+130px)] max-w-none shrink-0 bg-[#111727] border border-slate-800 rounded-2xl p-4 flex flex-col xl:flex-row items-center justify-between shadow-lg relative -left-[55px]">
