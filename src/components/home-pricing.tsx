            ...
            <CardHeader className="pt-8 text-left pb-4">
              <div className="flex items-start gap-3 px-2">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[13px] leading-tight font-medium text-slate-600 h-10 pr-2">
              ...
              <div className="mt-6 flex flex-row items-center justify-center gap-2 md:gap-4 text-xs font-semibold text-slate-700 bg-slate-50 py-2.5 rounded-xl border border-slate-100 mx-1 whitespace-nowrap">
