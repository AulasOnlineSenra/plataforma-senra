...
export function FirebaseErrorListener() {
  // Use o tipo de erro específico para o estado para segurança de tipo.
  ...
  useEffect(() => {
    ...
    // Cancela a inscrição ao desmontar para evitar vazamentos de memória.
    return () => {
      errorEmitter.off('permission-error', handleError);
    };
  }, []);

  // Na nova renderização, se um erro existir no estado, lance-o.
  if (error) {
    throw error;
  }
