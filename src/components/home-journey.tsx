      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="relative mb-12 md:mb-24">
          ...
          <motion.div 
            ...
            className="relative flex overflow-x-auto snap-x snap-mandatory lg:grid lg:grid-cols-6 gap-4 pb-4 lg:pb-8 pt-6 lg:pt-8 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] -mx-4 px-4 lg:mx-0 lg:px-0"
          >
        ...
        <div className="bg-slate-950 rounded-[32px] py-[9.5px] px-[23px] lg:py-[20px] lg:px-12 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl overflow-hidden relative -mt-[50px] mb-[30px] z-20">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 relative z-10 w-full lg:w-auto">
            <button 
              ...
              className="group flex items-center justify-center md:justify-between gap-4 sm:gap-6 bg-amber-500 hover:bg-amber-400 transition-colors rounded-[26px] md:rounded-2xl py-[12.5px] md:py-[2.5px] px-[28.5px] md:px-4 sm:pr-6 sm:pl-4 w-full sm:w-auto text-left shadow-[0_4px_20px_rgba(245,158,11,0.25)]"
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-slate-900 text-[12px] md:text-sm leading-tight group-hover:text-black">
