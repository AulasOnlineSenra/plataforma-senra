      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-10 lg:mb-[68px]">
          <div className="order-2 lg:order-1">
            ...
            <div className="flex flex-col gap-0 -space-y-1 -translate-y-[25px] lg:translate-y-0 mt-[15px] lg:mt-0">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-slate-900 text-[14px] md:text-sm leading-tight group-hover:text-black">
