        ...
        <div className="relative flex flex-col lg:flex-row items-stretch justify-center gap-10 lg:gap-6 xl:gap-8 mb-20 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-start pt-10 shrink-0 relative z-10 w-full lg:w-auto translate-y-[90px]">
            ...
            <div className="relative z-10 mb-8 flex items-center justify-center">
              ...
              {/* Orbit Dots */}
              <div className="absolute w-[10px] h-[10px] rounded-full bg-blue-500 shadow-[0_0_0_2px_rgba(255,255,255,1)] z-20" style={{ top: '-4px', left: '34px' }} />
              <div className="absolute w-[10px] h-[10px] rounded-full bg-amber-500 shadow-[0_0_0_2px_rgba(255,255,255,1)] z-20" style={{ top: '-4px', right: '34px' }} />
