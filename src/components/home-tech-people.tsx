    ...
    <div className="w-full bg-[#fcfcfd] pt-[60px] lg:pt-20 pb-[10px] overflow-hidden font-sans">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row items-stretch justify-center relative mb-16 gap-4 lg:gap-0 lg:max-h-[600px] lg:-translate-y-[60px]">
          ...
          <div className="w-full lg:w-[380px] xl:w-[400px] bg-white rounded-[2rem] p-8 pb-[12px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative z-20 shrink-0 flex flex-col lg:-translate-x-[45px] lg:-translate-y-[30px]">
          ...
          {/* LEFT CONNECTOR */}
          <div className="hidden lg:flex flex-col justify-start pt-[60px] w-12 xl:w-20 relative shrink-0 z-0 -mx-8 xl:-mx-12 -translate-x-[5px] -translate-y-[30px]">
          ...
          <div className="flex flex-col items-center justify-start pt-4 lg:pt-10 shrink-0 relative z-10 w-full lg:w-auto translate-y-4 lg:translate-y-[90px]">
            ...
            <div className="relative z-10 mb-8 flex items-center justify-center">
              ...
              <div className="absolute w-[10px] h-[10px] rounded-full bg-blue-500 shadow-[0_0_0_2px_rgba(255,255,255,1)] z-20" style={{ top: '-2px', left: '19px' }}>
                <div className="absolute w-[2px] h-[60px] bg-blue-500 left-1/2 -translate-x-1/2 bottom-[10px] block md:hidden" />
              </div>
              <div className="absolute w-[10px] h-[10px] rounded-full bg-amber-500 shadow-[0_0_0_2px_rgba(255,255,255,1)] z-20 translate-y-[166px] md:translate-y-0" style={{ top: '-2px', right: '19px' }}>
                <div className="absolute w-[2px] h-[50px] bg-amber-500 left-1/2 -translate-x-1/2 top-[10px] block md:hidden" />
              </div>
          ...
          {/* RIGHT CONNECTOR */}
          <div className="hidden lg:flex flex-col justify-start pt-[60px] w-12 xl:w-20 relative shrink-0 z-20 -mx-8 xl:-mx-12 translate-x-[5px] -translate-y-[30px]">
            <svg className="w-full h-32" preserveAspectRatio="none" viewBox="0 0 100 100" style={{ overflow: 'visible' }}>
          ...
          <div className="w-full lg:w-[380px] xl:w-[400px] bg-white rounded-[2rem] p-8 pb-[12px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative z-10 shrink-0 flex flex-col translate-y-[5px] lg:translate-x-[30px] lg:-translate-y-[30px]">
            <div className="flex items-center gap-5 mb-10">
