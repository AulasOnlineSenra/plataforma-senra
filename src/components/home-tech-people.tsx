  ...
  return (
    <div className="w-full bg-[#fcfcfd] pt-[60px] lg:pt-20 pb-[10px] overflow-hidden font-sans">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* Main Layout Section */}
        <div className="flex flex-col lg:flex-row items-stretch justify-center relative mb-16 gap-4 lg:gap-0 lg:max-h-[600px] lg:translate-y-0">
          ...
          {/* LEFT CONNECTOR */}
          <div className="hidden lg:flex flex-col justify-start pt-[60px] w-12 xl:w-20 relative shrink-0 z-0 -mx-8 xl:-mx-12 -translate-x-[3px] -translate-y-[30px]">
          ...
          {/* RIGHT CONNECTOR */}
          <div className="hidden lg:flex flex-col justify-start pt-[60px] w-12 xl:w-20 relative shrink-0 z-20 -mx-8 xl:-mx-12 translate-x-[3px] -translate-y-[30px]">
            <svg className="w-full h-32" preserveAspectRatio="none" viewBox="0 0 100 100" style={{ overflow: 'visible' }}>
          ...
          <div className="w-full lg:w-[380px] xl:w-[400px] bg-white rounded-[2rem] p-8 pb-[12px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative z-10 shrink-0 flex flex-col translate-y-[5px] lg:translate-x-[50px] lg:-translate-y-[30px]">
            <div className="flex items-center gap-5 mb-10">
